...
class SE3CNN(nn.Module):
    ...
    def __init__(self, pool: str = "snub_cube", res_features: str = '2_96', init: str = 'delta'):
        ...
        layer_types = [
            (FieldType(self.gs, [self.build_representation(2)] * 8), 1024), 
            (FieldType(self.gs, [self.build_representation(3)] * 16), 2048),  
            (FieldType(self.gs, [self.build_representation(3)] * 24), 4096),  
            (FieldType(self.gs, [self.build_representation(3)] * 32), 8192),   
            (FieldType(self.gs, [self.build_representation(3)] * 16), 4096),  
            (FieldType(self.gs, [self.build_representation(3)] * 8), 2048),   
