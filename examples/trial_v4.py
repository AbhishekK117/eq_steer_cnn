...
if __name__ == '__main__':
    ...
    for unique_name in set(f[:-7] for f in train_files if f.endswith('_rho.h5')):
        ...
        test_rho_path = os.path.join(test_directory, unique_name + '_rho.h5')
        test_sad_path = os.path.join(test_directory, unique_name + '_sad.h5')
